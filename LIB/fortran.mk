...
post_dump_neighbors.f90 operator_reconstruction.f90 post_filtertest.f90 post_extract_slice.f90 post_turbulence.f90 \
compute_energy_dissipation.f90
...
$(OBJDIR)/module_operators.o: module_operators.f90 $(OBJDIR)/module_params.o $(OBJDIR)/module_timing.o \
	$(OBJDIR)/module_helpers.o volume_integral.f90 compute_vorticity.f90 divergence.f90 compute_Qcriterion.f90 compute_energy_dissipation.f90\
